...
const buttonVariants = cva(
  [
    ...
    "cursor-pointer text-xs tracking-widest uppercase", // Customized: pointer-style cursor, spaced uppercase
  ],
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-accent-400 dark:hover:text-neutral-50", // customized hover, dark bg state
        destructive:
        ...
        secondary:
          "bg-secondary text-secondary-foreground border border-secondary-foreground hover:bg-accent-400 hover:text-neutral-50 hover:border-accent-500", // customized
        ghost:
      ...
      size: {
        ...
        sm: "h-8 gap-1.5 px-3 has-[>svg]:px-2.5", // remove border radius
        lg: "h-10 px-6 has-[>svg]:px-4", // remove border radius
        icon: "size-9",
        "icon-sm": "size-8",
        "icon-lg": "size-10",
      },
